...
import { addTaskBoard } from '@/redux/reducers/TaskmanReducer'
import {
    Dialog,
    DialogContent,
    DialogDescription,
    ...
    return (
        ...
        <Dialog open={modalOpenState} onOpenChange={() => { dispatch(openView({ type: 'add' })) }}>
            <DialogTrigger asChild>
                <Button variant="outline" size="sm" >Create Board</Button>
            </DialogTrigger>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem >
                                    ...
                                    <FormControl>
                                        <Textarea rows='6' placeholder="Breif description about this task" {...field} />
                                    </FormControl>
                                    <FormMessage className='text-xs text-red-500' />
                                </FormItem>
                            )}
